...
const rules = [
  ...
  "DOMAIN,api.888188.me,🔗 全局直连",
  "DOMAIN,vodcnd10.rsfcxq.com,🔗 全局直连",
  "DOMAIN,msftconnecttest.com,🔗 全局直连",
  // MetaCubeX 规则集
...
function generateBaseProxyGroups(countryData) {
  ...
  return [
    ...
    },
    {
      ...
      ...countryManualOptions,...otherManualOptions],
      "include-all": false,
  ...
  return [
    {
      ...
      "name": "🌍 国外媒体",
      "type": "select",
      "proxies": ["🔰 模式选择", "⚙️ 节点选择", "♻️ 延迟选优", "🚑 故障转移", "⚖️ 负载均衡(散列)", "☁️ 负载均衡(轮询)", "🔗 全局直连", ...countryAutoOptions, ...countryManualOptions, ...otherAutoOptions, ...otherManualOptions],
      "include-all": false,
    ...
    },
    {
      ...
      "type": "select",
      "proxies": ["🔰 模式选择", "⚙️ 节点选择", "🔗 全局直连", "♻️ 延迟选优", "🚑 故障转移", "⚖️ 负载均衡(散列)", "☁️ 负载均衡(轮询)", ...countryAutoOptions, ...countryManualOptions, ...otherAutoOptions, ...otherManualOptions],
      "include-all": false,
